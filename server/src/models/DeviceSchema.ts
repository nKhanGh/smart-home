...
export const AddDeviceSchema = z.object({
  ...
  type: z.enum(["tempSensor", "lightSensor", "humiditySensor", "light", "fan"], { message: "Loại thiết bị không hợp lệ." })
});
...
export const UpdateDeviceSchema = z.object({
  ...
  mode: z.enum(["auto", "manual"], { message: "Chế độ phải là 'auto' hoặc 'manual'." }).optional()
});
